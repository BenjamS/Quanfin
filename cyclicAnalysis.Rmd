...
#usd/chf 15min maxlength=4000 rollWind=144
#SPY 1min maxlength4000 rollwind 233
#SPY 15min maxlength2000 rollwind 233
#eur/jpy gbp/jpy 15min maxlength2000 rollwind 233
#eur/usd maxlength2000 5min rollwind233 perfect fit
...
#aud/usd aud/jpy maxlength3000 60or30min rollwind144or233
#aud/jpy maxlength3000 5min rollwind233
#usd/jpy maxlength2000 15min rollwind233
#------------------------------------------------------
symb_currency_from <- "usd"#"chf"#"aud"#"gbp"#"eur"#"aud"#"gbp"#"aud"
symb_currency_to <- "jpy"
# OR stocks
stock_symbol <- NULL#"GLD" #"GAZ" #"WTI" #"RTY=F"#"NK=F"#"NG=F"#"FXI"#"SI=F"#"GC=F"#"NG=F"#"CL=F"#"EXS1.DE"#ZC=F#"HG=F" BNO CPER XLF "XLI", "XLK", "IYR", "XLV", "XLY", "XLP"
...
#------------------------------------------------------
max_length <- 2000 # max length of time series
rollWind <- 233
per_ema_for_detrend <- rollWind
backtest_fraction <- 1 / 9
lookAhead_fraction <- 1 / 9
...
gg_raw <- gg
#------------------------------------------------------------
gg_raw / gg_dt / gg_pctlOsc / plot_layout(ncol = 1, heights = c(1, 1/2, 1/2))
#------------------------------------------------------------
